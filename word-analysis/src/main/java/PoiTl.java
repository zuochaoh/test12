...
// 写入word输出
        ...
        try {
            ...
            XWPFTemplate xwpfTemplate = XWPFTemplate.compile("F:\\xm\\qihuo\\ruoyi-admin\\src\\main\\resources\\muban\\123.docx").render(data);
...
//          File xxx = new File(docName);
//          FileOutputStream out1 = new FileOutputStream(xxx);
//          xwpfTemplate.write(out1);
